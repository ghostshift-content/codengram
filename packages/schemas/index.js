...
export const PLANNER_VERSION = '3.0.0'              // adaptive holistic/workstream planning + durable checkpoints
export const PROMPT_VERSION = '3.0.0'               // bounded semantic-worker contract + bundled recon skill
